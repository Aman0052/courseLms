...
//     //function call for initiate the paymnent using razorpay
//     try {
//         const paymentResponse = await instance.orders.create(options);
...
//             const emailResponse = await mailSender(
//                 enrolledStudent.email,
//                 "Congratulations from StudyStream",
//                 "Congratulations, you are onboarded into new StudyStream Course"
//             );
